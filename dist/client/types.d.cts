import type { ICookieJar } from "../cookie/types.cjs";
import type { CasError } from "../errors/cas-error.cjs";
import type { Fetcher } from "../http/types.cjs";
import type { CasValidationSuccess } from "../parser/cas-xml.cjs";
declare const __brand: unique symbol;
/**
 * Nominal / Branded type helper.
 */
export type Brand<B, T = string> = T & {
    readonly [__brand]: B;
};
/**
 ...
 */
export declare function isServiceTicket(value: unknown): value is ServiceTicket;
/**
 * Asserts that a value is a valid CAS Service Ticket.
 */
export declare function assertServiceTicket(value: unknown): asserts value is ServiceTicket;
