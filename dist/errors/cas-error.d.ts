export type CasErrorKind = "ABORTED" | "TIMEOUT" | "CONFIGURATION_ERROR" | "CRYPTO_ERROR" | "AUTH_FAILED" | "CAPTCHA_REQUIRED" | "NETWORK_ERROR" | "UPSTREAM_ERROR" | "PROTOCOL_ERROR" | "VALIDATION_FAILED";
